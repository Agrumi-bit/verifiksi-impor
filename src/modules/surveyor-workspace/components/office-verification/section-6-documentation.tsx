...
import { DOC_TYPE_DEFS, MIN_DOCUMENTATION_REQUIRED, type DocumentationItemValues } from "./schema";
...
export function Section6Documentation({ documentation, onChange, onSave, onSaveNext, isSaving }: Props) {
