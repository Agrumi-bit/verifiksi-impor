...
export function Section7Findings({
  findings,
  explanation,
  impact,
  recommendation,
  ...
  return (
    <SectionShell
      index={7}
      title="Review Temuan Ketidaksesuaian"
      accent="amber"
      onSave={onSave}
    ...
    >
      ...
      <p className="mb-5 text-[13.5px] font-bold leading-relaxed text-[#c1440e]">
        Section ini menampilkan ringkasan temuan dari Section 1-6 yang berstatus &quot;Tidak Sesuai&quot;.
      </p>
      ...
      <div className="mb-5 rounded-xl border border-[#f0ded0] bg-white p-6">
        ...
        <div className="mb-4 text-[13px] text-[#8a96a8]">
          Sistem otomatis menampilkan daftar temuan ketidaksesuaian dari Section 1-6.
        </div>

        {findings.length === 0 ? (
          <div className="p-1 text-[13px] text-[#8a96a8]">Belum ada temuan ketidaksesuaian pada Section 1-6.</div>
        ) : (
          <div className="overflow-x-auto">
            <div className="min-w-[640px]">
              ...
              {findings.map((f) => (
                <div
                  key={f.no}
                  className="grid grid-cols-[0.4fr_1.4fr_1.8fr_0.9fr_1.8fr] items-start gap-3.5 border-b border-[#f0ded0] p-2.5 py-4"
                >
      ...
      <div className="mb-5 rounded-xl border border-[#f0ded0] bg-white p-6">
        ...
        />
        <div className="mb-4 text-xs text-[#8a96a8]">
          Jelaskan konteks dan klarifikasi terhadap temuan ketidaksesuaian yang ditemukan.
        </div>
        ...
        <div className="mb-4 text-xs text-[#8a96a8]">
          Berikan penilaian apakah temuan mempengaruhi kelayakan verifikasi.
        </div>
        ...
        />
        <div className="mb-4 text-xs text-[#8a96a8]">
          Berikan rekomendasi terkait temuan ketidaksesuaian kepada perusahaan atau reviewer.
        </div>
