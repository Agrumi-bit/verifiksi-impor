...
import type { FieldVerificationValues } from "./schema";

type Props = {
  values: Pick<FieldVerificationValues, "assignedDate" | "actualVisitDate" | "dateNotes">;
  onChange: (patch: Partial<FieldVerificationValues>) => void;
  onSave: () => void;
  onSaveNext: () => void;
  isSaving?: boolean;
};
