...
/** Read-only Surat Tugas preview for the surveyor-workspace Team tab — mirrors the paper-letter layout from Customer Relation Workspace's SuratTugasModal, minus the approval-workflow actions (surveyor has no authority over that lifecycle, view/print only). */
