...
export function TopNavBar() {
  ...
  const role = (session?.user as { role?: string } | undefined)?.role ?? "Project Manager";
  ...
  return (
    <header className="fixed top-0 z-50 flex h-[60px] w-full items-center gap-7 border-b border-[#f0ded0] bg-[#fffaf6] px-6 md:pl-[254px]">
      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuItem
              render={<Link href="/project-manager-workspace/account" />}
