...
function useScheduleQuery() {
  return useQuery({
    queryKey: ["technical-analyst-workspace", "schedule"],
    queryFn: async () => {
      const response = await fetch("/api/technical-analyst-workspace/schedule");
      ...
      <div className="flex flex-wrap items-start justify-between gap-3.5">
        <div>
          ...
          <div className="mt-1 text-[13px] text-[#8a7565]">
            Kelola dan pantau jadwal analisis teknis Anda.
          </div>
        </div>
