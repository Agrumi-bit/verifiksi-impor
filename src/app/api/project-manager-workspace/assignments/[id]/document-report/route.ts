...
export async function GET(_request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const companySkt = company
    ? { sktNumber: company.sktNumber, sktIssuer: company.sktIssuer, sktDate: company.sktDate ? company.sktDate.toISOString() : null, sktDocumentPath: company.sktDocumentPath }
    : null;
